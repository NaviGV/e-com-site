...
const collection = () => {
  ...
  const{products , search , setSearch, showSearch , setShoeSearch} = useContext(ShopContext);
  ...
  const sortProduct = (filteredProduct) =>{

    let fpCopy = [...filteredProduct];
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        <p onClick={()=>setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer'>Filter
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          <Title text1={'ALL'} text2={'COLLCETIONS'}/>
          {/*product sort */}
